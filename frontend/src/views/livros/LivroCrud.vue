<template>
    <div class="container mx-auto p-8">
        ...
        <LivroForm v-if="showForm" :livro-editar="livroEditar" @cancelar="cancelarEdicao"
            @livro-salvo="atualizarLista" />
        <LivroList :livros="livros" @editar="editarLivro" @remover="removerLivro" />
        <button class="mt-4 bg-green-600 text-white px-4 py-2 rounded" v-if="!showForm" @click="novoLivro">
            Novo Livro
        </button>
    </div>
</template>
...
import LivroList from './LivroList.vue';
